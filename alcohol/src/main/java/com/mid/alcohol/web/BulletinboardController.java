...
public class BulletinboardController {
    ...
    @PostMapping("/update")
    public String readByIdUpdate(Bulletinboard deal, Model model) {
        log.info("update(deal={})", deal);
        
        int result = bulletinboardService.readByIdUpdate(deal);
        log.info("result= {}", result);
        
        BulletinboardDetailDto dto = bulletinboardService.selectById(deal.getBoard_id());
        model.addAttribute("deal", dto);
        
        return "redirect:/bulletinboard/board/detail?id=" + deal.getBoard_id();
    }
